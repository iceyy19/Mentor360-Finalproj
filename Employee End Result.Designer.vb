...
Partial Class Employee_End_Result
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Employee_End_Result))
        ...
        ' btnAnswer
        ' 
        btnAnswer.CustomizableEdges = CustomizableEdges24
